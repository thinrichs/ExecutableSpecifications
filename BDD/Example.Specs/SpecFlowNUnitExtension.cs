...
namespace TechTalk.SpecFlow
{
    ...
    public class SpecFlowNUnitExtension : IAddin, EventListener
    {
        ...
        {
            ITestRunner testRunner = (ITestRunner)typeof(ScenarioContext)
                .GetProperty("TestRunner", BindingFlags.Instance | BindingFlags.NonPublic)
                .GetValue(ScenarioContext.Current, null);
